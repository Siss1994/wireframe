...
gantt
    ...
    section 기획
    요구사항 분석 : done, 2024-01-01, 3d
    와이어프레임 : done, 2024-01-04, 2d

    section 개발
    API 설계 : active, 2024-01-06, 3d
    프론트엔드 : 2024-01-09, 5d
    백엔드 : 2024-01-09, 5d

    section QA
    테스트 : crit, 2024-01-14, 3d
```
...
gantt
    ...
    section 기획
    요구사항 정의 : 2024-01-01, 7d
    설계 : 2024-01-08, 7d

    section 개발
    MVP 개발 : 2024-01-15, 21d
...
5. **프로젝트 일정 요청**
   > "3주 스프린트의 Gantt 차트를 그려줘. 기획, 개발, 테스트 단계로 나눠서."
...
gantt
    ...
    section 기획
    요구사항 분석 : done, 2024-01-01, 5d
    와이어프레임 : done, 2024-01-06, 5d
    DB 설계 : done, 2024-01-11, 3d

    section 백엔드
    API 설계 : active, 2024-01-14, 3d
    인증 기능 : 2024-01-17, 5d
    상품 API : 2024-01-22, 5d
    주문 API : 2024-01-27, 7d

    section 프론트엔드
    UI 컴포넌트 : 2024-01-17, 7d
    상품 페이지 : 2024-01-24, 5d
    결제 페이지 : 2024-01-29, 7d

    section 테스트
    통합 테스트 : crit, 2024-02-05, 5d
    버그 수정 : 2024-02-10, 5d
```
